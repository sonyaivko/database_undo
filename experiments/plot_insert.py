...
ax.set_xlabel("batch size (rows)", fontsize=15)
...
ax.text(232, -0.9, "split here\n(gap: 52->400)", ha="center", fontsize=9, color="gray")
 
ax.set_ylim(-1.2, 2.2)
ax.set_yticks([])
ax.set_xlabel("c_id (illustrative scale)", fontsize=15)
...
ax.set_xlabel("cluster size (rows)", fontsize=15)
